                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="{{ $loop->iteration / 10 }}s">
                    <div class="room-item shadow-sm rounded overflow-hidden border border-light h-100 hover-shadow">
                        <div class="position-relative">
                            ...
                            text-white rounded py-1 px-3 ms-3 mt-3">${{ $room->price }}/Night</small>
                        </div>
                        <div class="p-4">
                            ...
                            <div class="d-flex gap-2">
                                <a class="btn btn-sm btn-primary rounded py-2 px-4 flex-fill" href="{{ route('rooms.show', ['room' => $room->id]) }}">View Detail</a>
                                <a class="btn btn-sm btn-outline-primary rounded py-2 px-4 flex-fill" href="{{ route('rooms.index') }}">Book Now</a>
                            </div>
                        </div>
                    </div>
                </div>
