...
<div class="container-fluid">
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-header bg-primary text-white">
            <h3 class="fw-bold mb-0">Edit Room Type</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('admin.roomtypes.update', $type->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <textarea name="desc" id="desc" rows="4"
                        ...
                        placeholder="Enter description">{{ old('desc', $type->desc) }}</textarea>
                    @error('desc')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
